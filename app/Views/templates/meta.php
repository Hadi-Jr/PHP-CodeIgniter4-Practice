...
<head>
    ...
    <!-- Jvector CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/plugins/jvector/css/jquery-jvectormap.css') ?>">
    <!-- Daterange CSS -->
    ...
    <link rel="stylesheet" href="<?= base_url('assets/plugins/sweet-alerts/css/sweetalert.css') ?>">
    <!-- Main CSS -->
